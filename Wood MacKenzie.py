...
def search_preferences(mywindfarms, mynum_answer, mytype_answer, mystatus_answer, myoutput_answer, mycost_answer,myptype_answer, mypstatus_answer, mypoutput_answer):
    ...
    if mynum_answer == "Portfolio":
        ...
        print("")
        print("Below are the most suitable and cost effective Wind Farms to make up your portfolio:")
        print("")
        print("Location".ljust(12), "Type".ljust(12), "Status".center(12), "Ouput(mw/h)".rjust(12), "Cost(per mw)".rjust(12))
        print("")
        for i in range(len(portfolio)):
            print((portfolio[i].location).ljust(12), (portfolio[i].type).ljust(12), (portfolio[i].status).center(12), (str(portfolio[i].output)).rjust(12), (str(portfolio[i].cost)).rjust(12))
